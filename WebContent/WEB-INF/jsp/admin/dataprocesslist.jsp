...
<body>
	<div id="container">
		...
		<div class="text-c" style="margin-top:1%;">
			<button onclick="open_layer('添加头页面','admindataprocessexcelimport','500','300')" href="javascript:;" class="btn btn-success" style="background-color: #337AB7;" type="submit"></i><i class="Hui-iconfont">&#xe645;</i> 导入</button>
	...
	$(document).ready(function() {
		...
		$('#example').DataTable( {
	       ...
	       "columns": [
	    	   ...
	    	   { "data": "age10" },
	    	   { "data": function(obj){ 
		           return "<span><center><a onclick=\"open_layer('录入','admindatarecordadd?dataprocess_id="+obj.dataprocess_id+"','900','450')\">录入</a></center></span>"
		       }     
	    	   }	
	    	   ],
	    	   "columnDefs": [      
...
function Excelbutton(){
	$.ajax({
	    type: "POST",
	    url:'admindataprocessExcel',
	    success: function(data) {
		    if(data.code==100){
		    	/* window.location.href="http://test.jikewangluo.cn/upload/数据处理.xls"; */
		    	window.location.href="http://localhost:8081/depot/upload/数据处理.xls";
		    }else{	
