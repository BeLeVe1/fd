...
<div class="wrapper" id="rrapp" v-cloak>
  <header class="main-header">
    <a href="javascript:void(0);" class="logo">
      ...
      <span class="logo-lg"><b>国能思达备品备件库存管理信息系统</b></span>
    </a>
    ...
    <nav class="navbar navbar-static-top" role="navigation">
	  ...
	  <div style="float:left;color:#fff;padding:15px 10px;">欢迎 ${admin.account}</div>
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li><a href="adminquit"><i class="fa fa-sign-out"></i> &nbsp;退出系统</a></li>
		</ul>
      </div>
    </nav>
  </header>
  ...
  <footer class="main-footer">
    ...
    Copyright &copy; 2019 <a href="#" target="_blank">cangchu</a> All Rights Reserved
  </footer>
...
<div id="passwordLayer" style="display: none;">
	...
	<div class="form-group">
		<div class="form-group">
		    ...
		    <span class="label label-success" style="vertical-align: bottom;">${admin.account}</span>
		</div>
		<div class="form-group">
