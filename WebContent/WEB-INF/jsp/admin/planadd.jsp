...
<body style="width: 80%;padding-left:10%;">
	<form  method="post" class="form form-horizontal" id="forms"  enctype="multipart/form-data">
		<div class="row cl" style="padding-top:2%;display:none">
			<label class="form-label col-xs-4 col-sm-2">plan_id：</label>
			<div class="formControls col-xs-7 col-sm-9">
				<input type="text" class="input-text" value="${plan.plan_id}" placeholder="" id="plan_id" name="plan_id">
			</div>
		</div>
		<div class="row cl" style="padding-top:2%;display:none">
			<label class="form-label col-xs-4 col-sm-2">plan_id：</label>
			<div class="formControls col-xs-7 col-sm-9">
				<input type="text" class="input-text" value="${flag}" placeholder="" id="flag" name="flag">
			</div>
		</div>
		<div class="row cl" style="padding-top:2%;">
			<label class="form-label col-xs-4 col-sm-2">器材名称：</label>
			<div class="formControls col-xs-7 col-sm-9">
				<input type="text" disabled="disabled" class="input-text" value="${dataprocess.qcname}" placeholder="" id="qcname" name="qcname">
			</div>
		</div>
		<div class="row cl" style="padding-top:2%;">
			<label class="form-label col-xs-4 col-sm-2">器材代码：</label>
			<div class="formControls col-xs-7 col-sm-9">
				<input type="text" disabled="disabled" class="input-text" value="${dataprocess.qccode}" placeholder="" id="qccode" name="qccode">
			</div>
		</div>
		<div class="row cl" style="padding-top:2%;">
			<label class="form-label col-xs-4 col-sm-2">年份：</label>
			<div class="formControls col-xs-7 col-sm-9">
				<input type="text" disabled="disabled" class="input-text" value="年份10" placeholder="" id="age" name="age">
			</div>
		</div>
		<div class="row cl" style="padding-top:2%;">
		...
		<div class="row cl" style="padding-top:2%;">
			<label class="form-label col-xs-4 col-sm-2">计划编制人：</label>
			<div class="formControls col-xs-7 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="planpeople" name="planpeople">
			</div>
		</div>
		<div class="row cl" style="padding-top:2%;">
			<label class="form-label col-xs-4 col-sm-2">责任人：</label>
			<div class="formControls col-xs-7 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="people" name="people">
			</div>
		</div>
		<div class="row cl" style="padding-top:2%;">
...
function sub(){
    ...
    if(forms.planpeople.value==""){
    	layer.msg('计划编制人不能为空');
    	return false;
    }
    if(forms.people.value==""){
    	layer.msg('责任人不能为空');
    	return false;
    }
    if(forms.text.value==""){
