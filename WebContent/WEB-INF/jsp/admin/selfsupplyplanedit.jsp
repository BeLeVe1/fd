...
<body style="width: 80%;padding-left:10%;">
	<form  method="post" class="form form-horizontal" id="forms"  enctype="multipart/form-data">
		...
		<div class="row cl" style="padding-top:2%;">
			<label class="form-label col-xs-4 col-sm-3">计划自筹数量：</label>
			<div class="formControls col-xs-7 col-sm-8">
				<input type="text" class="input-text" disabled="disabled" value="${plannumber}" placeholder="" id="plannumber" name="plannumber">
			</div>
		</div>
		<div class="row cl" style="padding-top:2%;">
			<label class="form-label col-xs-4 col-sm-3">期初库存：</label>
			<div class="formControls col-xs-7 col-sm-8">
				<input type="text" class="input-text" disabled="disabled" value="${number}" placeholder="" id="currentinventory" name="currentinventory">
			</div>
		</div>
		<div class="row cl" style="padding-top:2%;">
			<label class="form-label col-xs-4 col-sm-3">实际自筹数量：</label>
			<div class="formControls col-xs-7 col-sm-8">
				<input type="text" class="input-text" value="${lastnumber}" placeholder="" id="realnumber" name="realnumber">
			</div>
		</div>
...
function sub(){
	...
	if(forms.realnumber.value==""){
    	layer.msg('请输入计划自筹数量！');
    	return false;
    }
    $.ajax( {  
        type : 'POST',  
        url : 'adminselfsupplyplaneditajax',  
        data : params,  
