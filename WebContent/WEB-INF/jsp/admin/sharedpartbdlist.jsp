...
<body>
	<div id="container">
		...
		<div class="text-c" style="margin-top:1%;">
			<button onclick="Excelbutton();" class="btn btn-success" style="background-color: 慕#337AB7;" type="submit"></i><i class="Hui-iconfont">&#xe644;</i> 备份</button>
			<button onclick="open_layer('编辑','adminkydbdedit','900','450')" class="btn btn-success" style="background-color: #337AB7;" type="submit"></i><i class="Hui-iconfont">&#xe635;</i> 满足率</button>
			<button onclick="open_layer('编辑','adminamountbdlist','1000','600')" class="btn btn-success" style="background-color: #337AB7;" type="submit"></i><i class="Hui-iconfont">&#xe61a;</i> 统计</button>
			...
			<table id="example" class="table table-striped table-bordered">
				<thead>
					<tr>
						...
						<th style="text-align: center;width: 1%">计量单位<input type="checkbox" onclick="checkbtn1();" id="predictionnumber" name="predictionnumber" value=""></th>
						<th style="text-align: center;width: 1%">单价<input type="checkbox" onclick="checkbtn3();" id="maxnumber" name="maxnumber" value=""></th>
...
function Excelbutton(){
	$.ajax({
	    type: "POST",
	    url:'adminsharedpartbdExcel',
	    success: function(data) {
		    if(data.code==100){
		    	window.location.href="http://localhost:8081/depot/upload/共用件优化-部队级.xls";
		    }else{	
