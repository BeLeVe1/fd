...
<body>
	<div id="container">
		...
		<div class="text-c" style="margin-top:1%;">
			...
			<button onclick="open_layer('编辑','adminkydjqedit','900','450')" class="btn btn-success" style="background-color: #337AB7;" type="submit"></i><i class="Hui-iconfont">&#xe635;</i> 满足率</button>
			<button onclick="open_layer('编辑','adminamountjqlist','1000','600')" class="btn btn-success" style="background-color: #337AB7;" type="submit"></i><i class="Hui-iconfont">&#xe61a;</i> 统计</button>
...
function Excelbutton(){
	$.ajax({
	    type: "POST",
	    url:'adminsharedpartjqExcel',
	    success: function(data) {
		    if(data.code==100){
		    	window.location.href="http://localhost:8081/depot/upload/共用件优化-军区级.xls";
		    }else{	
