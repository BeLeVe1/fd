...
<!-- 						<th style="text-align: center;width: 1%"><input type="checkbox" onclick="ckAll();" id="allChecks" name="" value="" style="zoom:150%;"></th>						 -->
						...
						<th style="text-align: center;width: 1%">实时库存</th>
												<th style="text-align: center;width: 1%">安全库存</th>
						<th style="text-align: center;width: 1%">服务水平</th>
						<th style="text-align: center;width: 1%">订货批量</th>
...
// 	    	   { "data": function(obj){
// 	            	if(obj.czflag==1){
// 	            		return "<span><center><a onclick=\"open_layer('修改','adminstorehouseedit?jqcode="+obj.jqcode+"&bdcode="+obj.bdcode+"&zbcode="+obj.zbcode+"&qccode="+obj.qccode+"&qcname="+obj.qcname+"&unit="+obj.unit+"&unitprice="+obj.unitprice+"&dzys="+obj.dzys+"&currentinventory="+obj.currentinventory+"','900','450')\">调拨</a></center></span>"
// 	            	}else{
