...
<!-- 			</div> -->
		...
		<div class="row cl" style="padding-top:2%;">
			...
			<div class="formControls col-xs-7 col-sm-8">
				<input type="text" class="input-text" readonly="readonly" value="${to_store}" placeholder="" id="to_store" name="to_store">
			</div>	
		</div>
		<div class="row cl" style="padding-top:2%;">
		...
		<div class="row cl" style="padding-top:2%;">
			<label class="form-label col-xs-4 col-sm-3">调出仓库当前库存：</label>
			<div class="formControls col-xs-7 col-sm-8">
				<input type="text" class="input-text" readonly="readonly" value="${from_store_currentinventory}" placeholder="" id="from_store_currentinventory" name="from_store_currentinventory">
			</div>
		</div>
		<div class="row cl" style="padding-top:2%;">
...
function sub(){
    ...
    $.ajax( {  
        type : 'POST',  
        url : 'adminstorerecordchangeajax',  
        data : params, 
